...
test("Testing 19 for prime. Expect True.", pnt.big_number_recursion_test(19), True)
start = time.time()
print("Testing a bigger number using big_number_recursion_test. (Square root method)")
test("Testing 100003679 for prime. Expect True.", pnt.big_number_recursion_test(100003679), True)
